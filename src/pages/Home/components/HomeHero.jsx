    ...
    <div className="bg-[#495E57] grid grid-cols-1 xl:grid-cols-2 gap-12 py-12 mb-24 px-8 md:px-40">
      <div className="flex items-center text-white">
        <div className="block">
          ...
          <Link to="/reserve">
            <Button classname="my-8 p-4 bg-[#F4CE14] text-black rounded-lg hover:scale-105  transition-all duration-300 ease-in-out">
              Reserve a table
            </Button>
          </Link>
        </div>
      ...
      <div className="flex justify-center items-end">
        <img
          className="rounded-2xl -mb-24 border-8 border-[#fff]  transition-all duration-500 ease-in-out lg:w-9/12"
